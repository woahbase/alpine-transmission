...
MOUNTFLAGS := -v $(CURDIR)/downloads:/var/lib/transmission/downloads \
	-v $(CURDIR)/config:/var/lib/transmission/config \
	-v $(CURDIR)/torrents:/var/lib/transmission/torrents
...
PORTFLAGS  := -p 9091:9091 -p 52437:52437 -p 52437:52437/udp

RUNFLAGS   := -c 256 -m 512m \
...
test :
	docker run --rm -it $(NAMEFLAGS) $(RUNFLAGS) $(OTHERFLAGS) $(IMAGETAG) sh -ec 'transmission-daemon --version; transmission-cli --version'
