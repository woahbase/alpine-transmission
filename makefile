...
MOUNTFLAGS := -v $(CURDIR)/downloads:/var/lib/transmission/downloads -v $(CURDIR)/config:/var/lib/transmission/config -v $(CURDIR)/torrents:/var/lib/transmission/torrents
...
RUNFLAGS   := -c 256 -m 512m -e PGID=$(PGID) -e PUID=$(PUID)
